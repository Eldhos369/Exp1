...
namespace db {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public usersRow AddusersRow(int Id, string name, int salary) {
...
namespace db.Database1DataSet1TableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[users] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND" +
                " [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_salary = 1 AND [sal" +
                "ary] IS NULL) OR ([salary] = @Original_salary)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([Id], [name], [salary]) VALUES (@Id, @name, @salary);\r" +
                "\nSELECT Id, name, salary FROM users WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [Id] = @Id, [name] = @name, [salary] = @salary WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)));
SELECT Id, name, salary FROM users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::db.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, salary FROM dbo.users";
        ...
        public virtual int Delete(int Original_Id, string Original_name, global::System.Nullable<int> Original_salary) {
        ...
        public virtual int Insert(int Id, string name, global::System.Nullable<int> salary) {
        ...
        public virtual int Update(int Id, string name, global::System.Nullable<int> salary, int Original_Id, string Original_name, global::System.Nullable<int> Original_salary) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> salary, int Original_Id, string Original_name, global::System.Nullable<int> Original_salary) {
